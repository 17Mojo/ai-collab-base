...
class ScenarioDetector:
    ...
    SCENARIO_RULES = {
        ScenarioType.CODING: {
            "directories": ["src", "app", "lib", "services", "controllers", "models", "handlers", "utils", "core", "api"],
            "files": ["*.py", "*.js", "*.ts", "*.java", "*.go", "*.rs", "*.cpp", "*.jsx", "*.tsx", "*.rb", "*.php"],
            "patterns": [
                "class \\w+",
                "def \\w+",
                "function \\w+",
        ...
        ScenarioType.RESEARCH: {
            "directories": ["docs", "research", "references", "literature", "papers", "studies", "data"],
            "files": ["*.md", "*.pdf", "*.doc", "*.docx", "*.bib", "*.tex", "*.rst", "*.ipynb"],
            "patterns": ["# ", "## ", "### ", "### ", "[1]", "[2]", "@article", "Abstract", "Introduction"],
            "weight": 1.0,
        },
        ScenarioType.WRITING: {
            "directories": ["content", "posts", "articles", "blog", "drafts", "pages", "stories"],
            "files": ["*.md", "*.txt", "*.rst", "*.adoc", "*.html", "*.xml"],
            "patterns": ["title:", "---\n", "date:", "tags:", "author:", "category:", "excerpt:"],
            "weight": 1.0,
        },
        ScenarioType.DEBUGGING: {
            "directories": ["logs", "tests", "debug", "trace", "fixtures", "mocks"],
            "files": ["*test*.py", "*spec*.js", "*.log", "error.txt", "*test*.ts", "*.trace"],
            "patterns": [
                "print(",
                "console.log(",
                "assert ",
